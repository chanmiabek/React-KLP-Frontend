...
const Footer = () => {
    ...
    return (
        <footer className="footer-klp bg-dark text-light py-4 mt-auto"> {/* Reduced py-5 to py-4 */}
            <div className="container">
                <div className="row gy-4 text-start">

                    {/* About / Logo */}
                    <div className="col-lg-3 col-md-6">
                        <h4 className="fw-bold text-primary mb-3">KLP</h4>
                    ...
                    <div className="col-lg-2 col-md-6">
                        ...
                        <ul className="list-unstyled">
                            <li><Link to="/features/online-courses" className="footer-link">Online Courses</Link></li>
                    ...
                    <div className="col-lg-2 col-md-6">
                        ...
                        <ul className="list-unstyled">
                            <li className="d-flex align-items-center mb-2">
                                ...
                                <span className="small text-muted">Kakuma, Turkana County, Kenya</span>
                            </li>
                            <li className="d-flex align-items-center mb-2">
                                <FaEnvelope className="me-2 text-primary" />
                                <a href="mailto:info@klp.org" className="footer-link small">info@klp.org</a>
                            </li>
                            <li className="d-flex align-items-center">
                                <FaPhone className="me-2 text-primary" />
                                <a href="tel:+25792244883" className="footer-link small">+254 7922244883</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="small text-muted">Subscribe to our newsletter for the latest updates.</p>
                        <form className="mb-3">
            ...
            {/* Back to Top */}
            {showTopBtn && (
                <button className="back-to-top-btn btn btn-primary rounded-circle" onClick={scrollToTop} title="Back to top" aria-label="Back to top">
                    <FaArrowUp />
                </button>
            )}
        </footer>
